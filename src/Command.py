...
DEFAULT_KEY_MAP ={
  ...
  pygame.K_1: CommandId.GENERATE_T1,
  pygame.K_2: CommandId.GENERATE_T2,
  pygame.K_3: CommandId.GENERATE_T3,
  pygame.K_4: CommandId.GENERATE_WORKER,
  ...
  pygame.K_x: CommandId.DESELECT,
  pygame.K_q: CommandId.SEARCH_NEARBY_RIVAL,
}
...
DEFAULT_COMMAND_MAP = {
 ...
 CommandId.GENERATE_T1: pygame.K_1,
 CommandId.GENERATE_T2: pygame.K_2,
 CommandId.GENERATE_T3: pygame.K_3,
 CommandId.GENERATE_WORKER: pygame.K_4,
 ...
 CommandId.DESELECT: pygame.K_x,
 CommandId.SEARCH_NEARBY_RIVAL: pygame.K_q,
}

...
class Interface():
    ...
    def loadAllButton(self):
        ...
        aux = UpgradeButton.UpgradeButton(BUTTON_PATH + "mineUpgrade" + ".png", CommandId.UPGRADE_WORKER_MINING,BUTTON_PATH + "cartelUpgrade.bmp", "Reducir tiempo de;minado de los trabajadores", 5, 50)
    ...
    def getButton(self, entityOptions):
        ...
        for e in entityOptions:
            if e == Options.ARMOR_UPGRADE:
                ...
                self.allButton[e].nextLevel = self.player.armorUpgrade + 1
                ...
                self.allButton[e].nextLevel = self.player.dañoUpgrade + 1
                buttons.append(self.allButton[e])
                ...
                self.allButton[e].nextLevel = self.player.mineUpgrade + 1
                buttons.append(self.allButton[e])
            elif e != Options.NULO:
                buttons.append(self.allButton[e])

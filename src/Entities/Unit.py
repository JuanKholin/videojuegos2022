...
class Unit(Entity):
    ...
    def drawInfo(self, screen, color):
        ...
        muestra_texto(screen, str('monotypecorsiva'), dic['nombre'], color, 25, [Utils.ScreenWidth/2 - GUI_INFO_X2, Utils.ScreenHeight/2 - GUI_INFO_Y2])
        muestra_texto(screen, str('monotypecorsiva'), dic['funcion'], color, 20, [Utils.ScreenWidth/2 - GUI_INFO_X2, Utils.ScreenHeight/2 - GUI_INFO_Y2 + 50])

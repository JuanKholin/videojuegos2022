...
class Zerg2(Structure):
    ...
    def __init__(self, xini, yini, player, map, building):
        ...
        self.sprites = cargarSprites(S2_PATH, self.nSprites, False, BLUE2, 1.4, 0)
        ...
        #self.raton = raton
        self.render = pygame.transform.scale(pygame.image.load(S2_RENDER), RENDER_SIZE)

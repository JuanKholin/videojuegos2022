...
class Structure(Entity.Entity):
    ...
    def drawInfoBuilding(self, screen, color):
        ...
        if progreso > 1:
            progreso = 1
        pg.draw.rect(screen, BLUE2, pg.Rect(Utils.ScreenWidth/2 - GUI_INFO_X2 - 75, Utils.ScreenHeight - GUI_INFO_Y2 + 55, 150*(progreso), 15))
        pg.draw.rect(screen, BLUE, pg.Rect(Utils.ScreenWidth/2 - GUI_INFO_X2 - 75, Utils.ScreenHeight - GUI_INFO_Y2 + 55, 150, 15), 2)

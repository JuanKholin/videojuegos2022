    ...
    def draw(self, screen, x, y):
        ...
        if self.collide:
            if self.cartel != None:
                ...
                if self.costeGas == 0:
                    muestra_texto(screen, 'monotypecorsiva', "1", GREEN2, 20, (self.x + 70 - self.cartelPad , self.y - 23))
                else:
                    muestra_texto(screen, 'monotypecorsiva', "1", GREEN2, 20, (self.x + 140 - self.cartelPad , self.y - 23))

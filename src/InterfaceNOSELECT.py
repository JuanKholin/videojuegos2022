...
class Interface():
    ...
    def loadAllButton(self):
        ...
        aux = Button.Button(BUTTON_PATH + "zerg_refinery" + ".bmp", CommandId.BUILD_REFINERY, BUTTON_PATH + "construirConMineralZerg.png", "Construir Extractor", 5, EXTRACTOR_MINERAL_COST, 0, 45)
